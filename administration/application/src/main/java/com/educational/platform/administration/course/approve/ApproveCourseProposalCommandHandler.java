...
public class ApproveCourseProposalCommandHandler {
    ...
    public ApproveCourseProposalCommandHandler(TransactionTemplate transactionTemplate, CourseProposalRepository repository, IntegrationEventOutbox integrationEventOutbox) {
    ...
    public void handle(ApproveCourseProposalCommand command) {
        ...
        integrationEventOutbox.publish(new CourseApprovedByAdminIntegrationEvent(dto.uuid()));
    }
}
