...
/**
 * Tests that declining a previously-approved proposal succeeds at the handler level
 * and publishes the correct integration event.
 */
@ExtendWith(MockitoExtension.class)
public class DeclineCourseProposalFromApprovedStateTest {
    ...
    @Test
    void handle_previouslyApprovedProposal_declinesAndPublishesEvent() {
        // given
        ...
        // when
        sut.handle(new DeclineCourseProposalCommand(uuid));
        ...
        final ArgumentCaptor<CourseDeclinedByAdminIntegrationEvent> eventCaptor =
