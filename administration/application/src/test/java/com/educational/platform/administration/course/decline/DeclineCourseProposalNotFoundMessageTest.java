...
/**
 * Verifies that {@link DeclineCourseProposalCommandHandler} includes the
 * UUID in the {@link ResourceNotFoundException} message when the proposal is not found.
 */
@ExtendWith(MockitoExtension.class)
public class DeclineCourseProposalNotFoundMessageTest {
    ...
    void handle_proposalNotFound_exceptionMessageContainsUuid() {
        ...
        // when / then
        assertThatThrownBy(() -> sut.handle(new DeclineCourseProposalCommand(uuid)))
