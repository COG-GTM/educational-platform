...
/**
 * Additional Spring Retry edge-case integration tests for {@link SendCourseToApproveIntegrationEventHandler}.
 * Covers exception transition scenarios (retryable -> non-retryable on subsequent attempts)
 * and deep exception hierarchy subclasses that complement the base {@link SendCourseToApproveRetryIntegrationTest}.
 */
@ExtendWith(SpringExtension.class)
@ContextConfiguration(classes = SendCourseToApproveRetryEdgeCaseTest.RetryTestConfig.class)
class SendCourseToApproveRetryEdgeCaseTest {
