...
public class JwtTokenFilterValidationFalseTest {
    ...
    @Test
    void doFilterInternal_tokenPresentButValidationReturnsFalse_doesNotSetAuthenticationAndContinuesChain() throws ServletException, IOException {
        // given
