...
class CourseApprovedByAdminIntegrationEventHandlerRetryTest {
    ...
    void setUp() {
        ...
        context.refresh();
        sut = context.getBean(CourseApprovedByAdminIntegrationEventHandler.class);

        logger = (Logger) LoggerFactory.getLogger(CourseApprovedByAdminIntegrationEventHandler.class);
    ...
    @Test
    void handleCourseApprovedByAdminEvent_alwaysFails_retriedThreeTimesThenRecoverLogsAndSwallows() {
        // given
        ...
        // when
        assertThatCode(() -> sut.handleCourseApprovedByAdminEvent(event)).doesNotThrowAnyException();
    ...
    @Test
    void handleCourseApprovedByAdminEvent_failsTwiceThenSucceeds_notRecovered() {
        // given
        final UUID uuid = UUID.fromString("123e4567-e89b-12d3-a456-426655440001");
        final CourseApprovedByAdminIntegrationEvent event = new CourseApprovedByAdminIntegrationEvent(uuid);
    ...
    @Test
    void handleCourseApprovedByAdminEvent_succeedsFirstAttempt_invokedOnce() {
        // given
        final UUID uuid = UUID.fromString("123e4567-e89b-12d3-a456-426655440001");
        final CourseApprovedByAdminIntegrationEvent event = new CourseApprovedByAdminIntegrationEvent(uuid);
