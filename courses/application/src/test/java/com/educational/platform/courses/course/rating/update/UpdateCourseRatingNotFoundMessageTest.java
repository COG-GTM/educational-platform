...
/**
 * Verifies that {@link UpdateCourseRatingCommandHandler} includes the
 * UUID in the {@link ResourceNotFoundException} message when the course is not found.
 */
@ExtendWith(MockitoExtension.class)
public class UpdateCourseRatingNotFoundMessageTest {
    ...
    void handle_courseNotFound_exceptionMessageContainsUuid() {
        ...
        // when / then
        assertThatThrownBy(() -> sut.handle(new UpdateCourseRatingCommand(uuid, 3.5)))
