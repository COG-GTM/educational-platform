...
class IncreaseNumberOfStudentsCommandHandlerTest {
    ...
    @Test
    void handle_existingCourse_numberOfStudentsIncreased() {
        // given
    ...
    @Test
    void handle_nonExistingCourse_resourceNotFoundException() {
        // given
        final UUID uuid = UUID.fromString("123e4567-e89b-12d3-a456-426655440001");
        final IncreaseNumberOfStudentsCommand command = new IncreaseNumberOfStudentsCommand(uuid);
