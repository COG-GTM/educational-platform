...
public class CourseApprovedByAdminIntegrationEventHandlerTest {
    ...
    @Test
    void handleCourseApprovedByAdminEvent_onDataIntegrityViolationException_doesNotInteractWithFailedEventRepository() {
        // given
        final UUID uuid = UUID.fromString("123e4567-e89b-12d3-a456-426655440001");
        final CourseApprovedByAdminIntegrationEvent event = new CourseApprovedByAdminIntegrationEvent(uuid);
        doThrow(new DataIntegrityViolationException("constraint violation"))
    ...
    @Test
    void handleCourseApprovedByAdminEvent_ConcurrencyFailureExceptionFromCommandHandler_preservesExceptionIdentity() {
        // given
        final UUID uuid = UUID.fromString("123e4567-e89b-12d3-a456-426655440001");
        final CourseApprovedByAdminIntegrationEvent event = new CourseApprovedByAdminIntegrationEvent(uuid);
    ...
    @Test
    void handleCourseApprovedByAdminEvent_onConcurrencyFailureException_doesNotInteractWithFailedEventRepository() {
        // given
        final UUID uuid = UUID.fromString("123e4567-e89b-12d3-a456-426655440001");
        final CourseApprovedByAdminIntegrationEvent event = new CourseApprovedByAdminIntegrationEvent(uuid);
    ...
    @Test
    void handleCourseApprovedByAdminEvent_resourceNotFoundException_preservesExceptionIdentity() {
        // given
        final UUID uuid = UUID.fromString("123e4567-e89b-12d3-a456-426655440001");
        final CourseApprovedByAdminIntegrationEvent event = new CourseApprovedByAdminIntegrationEvent(uuid);
    ...
    void recover_withCustomDataAccessExceptionSubclass_persistsActualRuntimeClassName() throws Exception {
        ...
        assertThat(persistedClassName).contains("CourseApprovedByAdminIntegrationEventHandlerTest");
    }
    ...
    void recover_eventClassNameAndPayloadAreNotSwapped() throws Exception {
        ...
        assertThat(eventClassName).isEqualTo(CourseApprovedByAdminIntegrationEvent.class.getName());
    ...
    void recover_afterSuccessfulHandle_persistsIndependentRecord() throws Exception {
        ...
        final UUID uuid1 = UUID.fromString("123e4567-e89b-12d3-a456-426655440001");
        final UUID uuid2 = UUID.fromString("123e4567-e89b-12d3-a456-426655440002");
        final CourseApprovedByAdminIntegrationEvent successEvent = new CourseApprovedByAdminIntegrationEvent(uuid1);
        final CourseApprovedByAdminIntegrationEvent failedEvent = new CourseApprovedByAdminIntegrationEvent(uuid2);
        final DataAccessResourceFailureException exception = new DataAccessResourceFailureException("DB down");

        // when
        sut.handleCourseApprovedByAdminEvent(successEvent);
        sut.recover(exception, failedEvent);

        // then
        verify(approveCourseCommandHandler).handle(any());
        final ArgumentCaptor<FailedIntegrationEventRecord> captor = ArgumentCaptor.forClass(FailedIntegrationEventRecord.class);
        verify(failedIntegrationEventRepository).save(captor.capture());
    ...
    @Test
    void handleCourseApprovedByAdminEvent_exceptionWithNullMessage_rethrowsPreservingNullMessage() {
