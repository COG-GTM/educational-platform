...
public class CourseRatingRecalculatedIntegrationEventHandlerTest {
    ...
    @Test
    void handleCourseRatingRecalculatedEvent_ConcurrencyFailureExceptionFromCommandHandler_preservesExceptionIdentity() {
        // given
        final UUID uuid = UUID.fromString("123e4567-e89b-12d3-a456-426655440001");
        final CourseRatingRecalculatedIntegrationEvent event = new CourseRatingRecalculatedIntegrationEvent(uuid, 4.5);
    ...
    @Test
    void handleCourseRatingRecalculatedEvent_onConcurrencyFailureException_doesNotInteractWithFailedEventRepository() {
        // given
        final UUID uuid = UUID.fromString("123e4567-e89b-12d3-a456-426655440001");
        final CourseRatingRecalculatedIntegrationEvent event = new CourseRatingRecalculatedIntegrationEvent(uuid, 4.5);
    ...
    void recover_allFieldsCorrespondToCorrectSources() throws Exception {
        ...
        final CourseRatingRecalculatedIntegrationEvent event = new CourseRatingRecalculatedIntegrationEvent(uuid, 3.75);
    ...
    void recover_eventClassNameAndPayloadAreNotSwapped() throws Exception {
        ...
        assertThat(eventClassName).isEqualTo(CourseRatingRecalculatedIntegrationEvent.class.getName());
    ...
    void handle_successPath_commandHandlerCalledExactlyOnce_andNoOtherInteractions() {
        ...
        verify(updateCourseRatingCommandHandler, times(1)).handle(any());
        verifyNoMoreInteractions(updateCourseRatingCommandHandler);
        verifyNoInteractions(failedIntegrationEventRepository);
    }
    ...
    void recover_eventPayload_containsRecordFieldNames() throws Exception {
        ...
        assertThat(payload).contains("rating");
    }
    ...
    void recover_eventPayload_matchesJavaRecordToStringFormat() throws Exception {
        ...
        verify(failedIntegrationEventRepository).save(captor.capture());
        final String payload = (String) getField(captor.getValue(), "eventPayload");
        assertThat(payload).startsWith("CourseRatingRecalculatedIntegrationEvent[");
        assertThat(payload).endsWith("]");
        assertThat(payload).contains("courseId=123e4567-e89b-12d3-a456-426655440001");
        assertThat(payload).contains("rating=4.5");
    }
    ...
    @Test
    void handleCourseRatingRecalculatedEvent_eventUnchangedAfterHandling() {
        final UUID uuid = UUID.fromString("123e4567-e89b-12d3-a456-426655440001");
        final CourseRatingRecalculatedIntegrationEvent event = new CourseRatingRecalculatedIntegrationEvent(uuid, 4.5);
