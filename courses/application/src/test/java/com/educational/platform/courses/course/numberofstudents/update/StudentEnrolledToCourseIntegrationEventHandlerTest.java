...
public class StudentEnrolledToCourseIntegrationEventHandlerTest {
    ...
    void handleStudentEnrolledToCourseEvent_updateNumberOfStudentsCommandExecuted() {
        ...
        final StudentEnrolledToCourseIntegrationEvent event = new StudentEnrolledToCourseIntegrationEvent(uuid, UUID.fromString("123e4567-e89b-12d3-a456-426655440002"));
