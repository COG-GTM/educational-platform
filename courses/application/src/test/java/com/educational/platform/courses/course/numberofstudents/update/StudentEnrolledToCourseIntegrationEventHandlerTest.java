...
public class StudentEnrolledToCourseIntegrationEventHandlerTest {
    ...
    @Test
    void handleStudentEnrolledToCourseEvent_onDataIntegrityViolationException_doesNotInteractWithFailedEventRepository() {
        // given
        final UUID uuid = UUID.fromString("123e4567-e89b-12d3-a456-426655440001");
        final StudentEnrolledToCourseIntegrationEvent event = new StudentEnrolledToCourseIntegrationEvent(uuid, "student1");
        doThrow(new DataIntegrityViolationException("constraint violation"))
    ...
    @Test
    void handleStudentEnrolledToCourseEvent_concurrencyFailureException_rethrowsForRetry() {
    ...
    @Test
    void handleStudentEnrolledToCourseEvent_ConcurrencyFailureExceptionFromCommandHandler_preservesExceptionIdentity() {
        // given
        final UUID uuid = UUID.fromString("123e4567-e89b-12d3-a456-426655440001");
        final StudentEnrolledToCourseIntegrationEvent event = new StudentEnrolledToCourseIntegrationEvent(uuid, "student1");
    ...
    @Test
    void handleStudentEnrolledToCourseEvent_onConcurrencyFailureException_doesNotInteractWithFailedEventRepository() {
        // given
        final UUID uuid = UUID.fromString("123e4567-e89b-12d3-a456-426655440001");
        final StudentEnrolledToCourseIntegrationEvent event = new StudentEnrolledToCourseIntegrationEvent(uuid, "student1");
    ...
    @Test
    void recover_withNullUsernameAndConcurrencyFailure_persistsCorrectExceptionType() throws Exception {
        // given — null username combined with ConcurrencyFailureException
        final UUID uuid = UUID.fromString("123e4567-e89b-12d3-a456-426655440001");
        final StudentEnrolledToCourseIntegrationEvent event = new StudentEnrolledToCourseIntegrationEvent(uuid, null);
        final org.springframework.dao.ConcurrencyFailureException exception =
                new org.springframework.dao.ConcurrencyFailureException("Lock contention on student enrollment");
    ...
    void recover_withUnicodeUsername_persistsEventPayload() throws Exception {
        // given — unicode characters in username
        final UUID uuid = UUID.fromString("123e4567-e89b-12d3-a456-426655440001");
        final StudentEnrolledToCourseIntegrationEvent event =
                new StudentEnrolledToCourseIntegrationEvent(uuid, "\u00fc\u00f1\u00ee\u00e7\u00f8\u00f0\u00e9-student");
        final DataAccessResourceFailureException exception = new DataAccessResourceFailureException("DB error");
        ...
        verify(failedIntegrationEventRepository).save(captor.capture());
        assertThat(getField(captor.getValue(), "eventPayload")).isEqualTo(event.toString());
        assertThat(getField(captor.getValue(), "eventPayload").toString())
                .contains("\u00fc\u00f1\u00ee\u00e7\u00f8\u00f0\u00e9-student");
    }

    @Test
    void handleStudentEnrolledToCourseEvent_resourceNotFoundException_preservesExceptionIdentity() {
        // given
        final UUID uuid = UUID.fromString("123e4567-e89b-12d3-a456-426655440001");
        final StudentEnrolledToCourseIntegrationEvent event = new StudentEnrolledToCourseIntegrationEvent(uuid, "student1");
    ...
    void recover_withCustomDataAccessExceptionSubclass_persistsActualRuntimeClassName() throws Exception {
        ...
        assertThat(persistedClassName).contains("StudentEnrolledToCourseIntegrationEventHandlerTest");
    }
    ...
    void recover_allFieldsCorrespondToCorrectSources() throws Exception {
        ...
        final StudentEnrolledToCourseIntegrationEvent event = new StudentEnrolledToCourseIntegrationEvent(uuid, "test-student");
    ...
    void recover_eventClassNameAndPayloadAreNotSwapped() throws Exception {
        ...
        assertThat(eventClassName).isEqualTo(StudentEnrolledToCourseIntegrationEvent.class.getName());
    ...
    void handle_successPath_commandHandlerCalledExactlyOnce_andNoOtherInteractions() {
        ...
        verify(increaseNumberOfStudentsCommandHandler, times(1)).handle(any());
        verifyNoMoreInteractions(increaseNumberOfStudentsCommandHandler);
        verifyNoInteractions(failedIntegrationEventRepository);
    }
    ...
    void recover_afterSuccessfulHandle_persistsIndependentRecord() throws Exception {
        ...
        final UUID uuid1 = UUID.fromString("123e4567-e89b-12d3-a456-426655440001");
        final UUID uuid2 = UUID.fromString("123e4567-e89b-12d3-a456-426655440002");
        final StudentEnrolledToCourseIntegrationEvent successEvent = new StudentEnrolledToCourseIntegrationEvent(uuid1, "student1");
        final StudentEnrolledToCourseIntegrationEvent failedEvent = new StudentEnrolledToCourseIntegrationEvent(uuid2, "student2");
        final DataAccessResourceFailureException exception = new DataAccessResourceFailureException("DB down");

        // when
        sut.handleStudentEnrolledToCourseEvent(successEvent);
        sut.recover(exception, failedEvent);

        // then
        verify(increaseNumberOfStudentsCommandHandler).handle(any());
        final ArgumentCaptor<FailedIntegrationEventRecord> captor = ArgumentCaptor.forClass(FailedIntegrationEventRecord.class);
        verify(failedIntegrationEventRepository).save(captor.capture());
    ...
    @Test
    void handleStudentEnrolledToCourseEvent_exceptionWithNullMessage_rethrowsPreservingNullMessage() {
    ...
    void recover_eventPayload_matchesJavaRecordToStringFormat() throws Exception {
        ...
        verify(failedIntegrationEventRepository).save(captor.capture());
        final String payload = (String) getField(captor.getValue(), "eventPayload");
        assertThat(payload).startsWith("StudentEnrolledToCourseIntegrationEvent[");
        assertThat(payload).endsWith("]");
        assertThat(payload).contains("courseId=123e4567-e89b-12d3-a456-426655440001");
        assertThat(payload).contains("username=student1");
    }
    ...
    @Test
    void handleStudentEnrolledToCourseEvent_eventUnchangedAfterHandling() {
        final UUID uuid = UUID.fromString("123e4567-e89b-12d3-a456-426655440001");
        final StudentEnrolledToCourseIntegrationEvent event = new StudentEnrolledToCourseIntegrationEvent(uuid, "student1");
