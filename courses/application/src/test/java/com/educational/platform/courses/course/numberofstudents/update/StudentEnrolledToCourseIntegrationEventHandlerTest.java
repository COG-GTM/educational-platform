...
public class StudentEnrolledToCourseIntegrationEventHandlerTest {
    ...
    @Test
    void handleStudentEnrolledToCourseEvent_isAnnotatedForAfterCommitAsyncRetryAndRecover() throws NoSuchMethodException {
        final Method method = StudentEnrolledToCourseIntegrationEventHandler.class.getDeclaredMethod(
                "handleStudentEnrolledToCourseEvent",
        ...
        final boolean recoverMethodExists = java.util.Arrays.stream(StudentEnrolledToCourseIntegrationEventHandler.class.getDeclaredMethods())
