...
public class CreateTeacherCommandHandlerTest {
    ...
    @Test
    void handle_validTeacher_toIdentityReturnsUsername() {
        // given
        ...
        final ArgumentCaptor<Teacher> argument = ArgumentCaptor.forClass(Teacher.class);
        verify(repository).save(argument.capture());
        assertThat(argument.getValue().toIdentity()).isEqualTo("teacher-user");
    }

    @Test
    void handle_nullUsername_saveStillExecuted() {
        // given
    ...
    @Test
    void handle_emptyUsername_saveStillExecuted() {
        // given
    ...
    @Test
    void handle_saveCalledExactlyOnce() {
        // given
