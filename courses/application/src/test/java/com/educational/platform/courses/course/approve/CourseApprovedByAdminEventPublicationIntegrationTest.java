...
/**
 * Verifies that publishing a {@link CourseApprovedByAdminIntegrationEvent} through the Spring
...
@ContextConfiguration(classes = CourseApprovedByAdminEventPublicationIntegrationTest.PublicationTestConfig.class)
class CourseApprovedByAdminEventPublicationIntegrationTest {
