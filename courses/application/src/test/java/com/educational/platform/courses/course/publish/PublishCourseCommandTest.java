...
public class PublishCourseCommandTest {
    ...
    void constructor_uuidStored() {
        ...
        // when
        final PublishCourseCommand sut = new PublishCourseCommand(uuid);
    ...
    void constructor_nullUuid_storedAsNull() {
        // when
        final PublishCourseCommand sut = new PublishCourseCommand(null);
    ...
    void equalInstances_areEqual() {
        // given
        final UUID uuid = UUID.fromString("123e4567-e89b-12d3-a456-426655440001");
        final PublishCourseCommand a = new PublishCourseCommand(uuid);
        final PublishCourseCommand b = new PublishCourseCommand(uuid);
    ...
    void differentInstances_areNotEqual() {
        ...
        // then
        assertThat(new PublishCourseCommand(uuid1)).isNotEqualTo(new PublishCourseCommand(uuid2));
    }
}
