...
public class ListCourseReviewsByCourseUUIDQueryHandlerTest {
    ...
    @Test
    void handle_query_courseReviewsReturned() {
        // given
        ...
        final CourseReviewDTO review = new CourseReviewDTO(UUID.fromString("123e4567-e89b-12d3-a456-426655440002"), courseUuid, "username", "comment", 4.0);
