...
public class CourseReviewFactoryTest {
    ...
    @Test
    void createFrom_validCommand_courseAndReviewerReferencesSet() {
        // given
        final UUID uuid = UUID.fromString("123e4567-e89b-12d3-a456-426655440001");
        final ReviewCourseCommand command = new ReviewCourseCommand(uuid, 4.0, "comment");
    ...
    void createFrom_validCommand_uuidAssigned() {
        // given
        final UUID uuid = UUID.fromString("123e4567-e89b-12d3-a456-426655440001");
        final ReviewCourseCommand command = new ReviewCourseCommand(uuid, 3.0, "good");
    ...
    void createFrom_twoCalls_differentUuidsAssigned() {
        ...
        // when
        final CourseReview first = sut.createFrom(command);
        final CourseReview second = sut.createFrom(command);
    ...
    void createFrom_fractionalRating_courseReviewCreated() {
        // given
        final UUID uuid = UUID.fromString("123e4567-e89b-12d3-a456-426655440001");
        final ReviewCourseCommand command = new ReviewCourseCommand(uuid, 3.7, "decent");
