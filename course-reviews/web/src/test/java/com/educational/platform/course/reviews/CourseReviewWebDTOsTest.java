...
public class CourseReviewWebDTOsTest {
    ...
    void reviewCourseRequest_exposesRatingAndComment() {
        // when
        final ReviewCourseRequest request = new ReviewCourseRequest(4.5, "good course");

        // then
        assertThat(request.rating()).isEqualTo(4.5);
        assertThat(request.comment()).isEqualTo("good course");
    }
    ...
    void updateCourseReviewRequest_exposesRatingAndComment() {
        ...
        assertThat(request.comment()).isEqualTo("updated comment");
    }
