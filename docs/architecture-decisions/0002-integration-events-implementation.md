...
todo: For now, all events will be stored in integration-events module. But this solution should be reviewed. ~~Integration events should be published after successful transaction.~~ (resolved by [ADR-0014](0014-async-executor-and-after-commit-event-publishing.md): listeners now process events after transaction commit)
