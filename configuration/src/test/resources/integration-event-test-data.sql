...
--
-- The runtime schema is generated by Hibernate (create-drop), so the
-- numberOfStudents value object maps to column NUMBER and approval_status /
-- publish_status are H2 ENUM columns. This mirrors the existing fixtures in
